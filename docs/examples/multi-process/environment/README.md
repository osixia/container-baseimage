...
`.env` files in this directory and any sub-directories are loaded before executing services lifeycle scripts (`startup.sh`, `process.sh` and `finish.sh`) or entrypoint lifecycle pre-commands.
