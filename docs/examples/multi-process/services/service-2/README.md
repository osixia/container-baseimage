...
It can be incorporated later via the `container services require service-2` command.
...
# Require and download optional service(s)
...
A service may contain a `.tags` directory.
