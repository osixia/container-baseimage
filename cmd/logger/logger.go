...
func init() {
	...
	// subcommands
	LoggerCmd.AddCommand(newPrintLogCmd("fatal", "f", log.Fatal))
	LoggerCmd.AddCommand(newPrintLogCmd(log.Levels[log.LevelError], "e", log.Error))
	LoggerCmd.AddCommand(newPrintLogCmd(log.Levels[log.LevelWarning], "w", log.Warning))
	LoggerCmd.AddCommand(newPrintLogCmd(log.Levels[log.LevelInfo], "i", log.Info))
	LoggerCmd.AddCommand(newPrintLogCmd(log.Levels[log.LevelDebug], "d", log.Debug))
	LoggerCmd.AddCommand(newPrintLogCmd(log.Levels[log.LevelTrace], "t", log.Trace))
