...
var cmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		epo := helpers.MustVal(cmdFlags.toEntrypointOptions())
		epo.Args = args
...
func init() {
	...
	cmd.Flags().StringArrayVarP(&cmdFlags.exec, "exec", "x", nil, "execute only specified services\n")
	...
	helpers.Must(cmd.ValidateFlagGroups())
}
