...
Latest release: 0.1.7 [Changelog](CHANGELOG.md)
...
- [Debian](https://github.com/osixia/docker-light-baseimage)  | [Docker Hub](https://hub.docker.com/r/osixia/light-baseimage/) |  [![](https://images.microbadger.com/badges/image/osixia/light-baseimage.svg)](http://microbadger.com/images/osixia/light-baseimage "Get your own image badge on microbadger.com")

Table of Contents
- [osixia/alpine-light-baseimage](#osixiaalpine-light-baseimage)
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
	    ...
	    FROM osixia/alpine-light-baseimage:0.1.7
...
In the Dockerfile we are going to:
  ...
  - Download nginx and php7.0 from apk.
  - Add the service directory to the image.
  - Install service and clean up.
  - Add the environment directory to the image.
  - Define ports exposed and volumes if needed.
...
*Caution: The command executed must start a foreground process otherwise runit (use to supervise mutlple process images) will  keep restarting php-fpm7.*

That why we run php-fpm7 with `--nodaemonize"`
...
*Run tool* takes several options, to list them:
    ...
    docker run osixia/alpine-light-baseimage:0.1.7 --help
...
Example:
    ...
    docker run -it osixia/alpine-light-baseimage:0.1.7
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" osixia/alpine-light-baseimage:0.1.7 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" osixia/alpine-light-baseimage:0.1.7 printenv
