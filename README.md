...
Latest release: 0.1.4 - Beta -  [Changelog](CHANGELOG.md)
...
*Run tool* takes several options, to list them:
    ...
    docker run osixia/alpine-light-baseimage:0.1.4 --help
...
Example:
    ...
    docker run -it osixia/alpine-light-baseimage:0.1.4
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" osixia/alpine-light-baseimage:0.1.4 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" osixia/alpine-light-baseimage:0.1.4 printenv
