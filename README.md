...
Latest release: 1.1.0-dev -  [Changelog](CHANGELOG.md)
...
*Run tool* takes several options, to list them:
    ...
    docker run osixia/light-baseimage:1.1.0-dev --help
...
Example:
    ...
    docker run -it osixia/light-baseimage:1.1.0-dev
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" osixia/light-baseimage:1.1.0-dev printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" osixia/light-baseimage:1.1.0-dev printenv
