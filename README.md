...
Latest release: 0.2.7 -  [Changelog](CHANGELOG.md)
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
        ...
        FROM osixia/light-baseimage:0.2.7
...
*Run tool* takes several options, to list them:
    ...
    docker run osixia/light-baseimage:0.2.7 --help
...
Example:
    ...
    docker run -it osixia/light-baseimage:0.2.7
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" osixia/light-baseimage:0.2.7 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" osixia/light-baseimage:0.2.7 printenv
